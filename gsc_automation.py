...
PROPERTY_URL = "sc-domain:portpic.com"
...
def report_pages(service, days, limit):
    ...
    print("-" * 82)
    for i, row in enumerate(rows, 1):
        page = row["keys"][0].replace("https://portpic.com", "").replace("https://www.portpic.com", "")[:49] or "/"
...
def main():
    parser = argparse.ArgumentParser(description="GSC Automation - PortPic.com")
